...
# assigning column names to the data imported
...
# Readding the data from the test files
# importing the txt files
subjectTest = read.table('./test/subject_test.txt',header=FALSE);
xTest       = read.table('./test/x_test.txt',header=FALSE);
yTest       = read.table('./test/y_test.txt',header=FALSE);

# assigning column names to the test data imported
...
# merging training and test data to create a final dataset
